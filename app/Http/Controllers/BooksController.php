...
/**
    ...
    public function store(StoreBookRequest $request)
    {
        ...
        if ($request->hasFile('cover')) {
            ...
            // nama file random dengan extension
    ...
    public function update(UpdateBookRequest $request, $id)
    {
        ...
        if ($request->hasFile('cover')) {
            ...
            // pindahin file ke folder public/img
            $uploaded_cover->move($destinationPath, $filename);
    ...
    public function exportPost(Request $request)
{
    ...
    public function importExcel(Request $request)
    {
        ...
        foreach ($excels as $row) {
            ...
            // catat id dari buku yang baru 
            array_push($books_id, $book->id);
        }

        // Ambil semua buku yang baru 
   ...
   public function generateExcelTemplate() 
   {
    ...
    // Set the properties
    $excel->setTitle('Template Import Buku')->setCreator('Larapus')->setCompany('Larapus')->setDescription('Template import buku untuk Larapus');
