...
class MembersController extends Controller
{
    ...
    {
        $member = User::find($id); // Mencari data user berdasarkan ID
        return view('members.edit')->with(compact('member')); // Menampilkan file edit.blade.php sambil bawa data member
    }
